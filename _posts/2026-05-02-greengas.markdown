...
![as](/assets/images/adplant2.png)
_Figure 1. Anaerobic digesters._
...
It also avoids the immediate need for households to switch to heat pumps, which currently cost [around £11,000 to install](https://wattsthepoint.github.io/posts/why-install-a-heat-pump/). Green gas remains compatible with existing domestic gas boilers.
...
Where Ecotricity’s proposal differs from most existing AD projects is its use of grass as a feedstock. Grass is an unusual choice for anaerobic digestion due to its [relatively poor biogas yield](https://downloads.ctfassets.net/620j9bwnh4b6/2gSQuZOgxxs4dvkMW5mZDV/2356be083369cb8c68d87ed798ccf02e/Green_Gas_Report_2022.pdf) compared with crops such as maize.

However, grass can offer environmental advantages. It is generally [less damaging to soil quality than maize cultivation](https://downloads.ctfassets.net/620j9bwnh4b6/2gSQuZOgxxs4dvkMW5mZDV/2356be083369cb8c68d87ed798ccf02e/Green_Gas_Report_2022.pdf), while species-rich herbal leys can help improve biodiversity and increase soil carbon in depleted soils.

## Energy from solar versus biomethane production

Based on a solar farm having most frequently around [2 MW of installed capacity per hectare](https://assets.publishing.service.gov.uk/media/6762f035e6ff7c8a1fde9b48/Land_utilised_by_solar_PV__September_2024.pdf) and an average [capacity factor of 10%](https://www.statista.com/statistics/555697/solar-electricity-load-factor-uk/), an average solar farm would produce approximately 1,752 MWh of electricity per year per hectare. Comparing this to Ecotricity’s estimated biomethane energy potential of 36.6 MWh per hectare gives a factor of 47.8 in favour of solar generation. 

Furthermore, when considering useful heat output through heat pumps, assuming a [coefficient of performance of 3](https://wattsthepoint.github.io/posts/why-install-a-heat-pump/), the difference between biomethane heating using a gas boiler and solar-powered heating using heat pumps increases to approximately 143.4 times in favour of solar electricity. This comparison does not account for seasonal intermittency, energy storage requirements, or grid balancing costs associated with solar generation.
