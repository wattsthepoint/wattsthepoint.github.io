---
title:  "Uranium fever: why nuclear energy is safer than you thought"
date:   2026-02-25 02:00:24 +0000
categories: [Energy, Nuclear energy]
tags: [nuclear energy]     # TAG names should always be lowercase
---

Nuclear power generation is a major source of synchronous electricity generation in power systems worldwide, providing reliable and continuous low-carbon baseload power with no direct greenhouse gas emissions during operation. In Great Britain, it accounted for 11.8% of generation in 2025 according to the [National Energy System Operator](https://www.neso.energy/news/britains-energy-explained-2025-review). 

Currently operational stations are: [Torness](https://www.edfenergy.com/energy/power-stations/torness) (1.3 GW), [Hartlepool](https://www.edfenergy.com/energy/power-stations/hartlepool) (1.2 GW), Heysham ([1](https://www.edfenergy.com/energy/power-stations/heysham-1) & [2](https://www.edfenergy.com/energy/power-stations/heysham-2) combined c.2.5 GW), and [Sizewell B](https://www.edfenergy.com/energy/power-stations/sizewell-b) (1.2 GW). 
...
In the UK, nuclear energy, industrial and defence activities together account for less than 1% of the average annual radiation dose to the public, with the vast majority coming from natural sources ([UK Radioactive Waste Inventory](https://ukinventory.nda.gov.uk/information-hub/about-radioactive-waste/what-is-radioactivity/); [Public Health England](https://www.gov.uk/government/publications/ionising-radiation-exposure-of-the-uk-population-2010-review)).
...
Although this may appear to be a strong argument against nuclear power, up to [around 96% of the material in spent nuclear fuel is technically recyclable for future fuel use](https://www.sckcen.be/en/expertises/nuclear-systems/lead-cooled-fast-reactor-belgium/recycling-spent-nuclear-fuel), depending on national fuel cycle policy. The remaining fraction constitutes high-level waste requiring long-term management.
